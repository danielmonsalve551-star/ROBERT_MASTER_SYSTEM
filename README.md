...
Este repositorio funciona como respaldo documental, control de versiones y base futura para el MVP técnico de Robert.
...
Este repositorio no autoriza programación, automatizaciones, conexiones externas ni agentes autónomos.
...
Convención visual validada y registrada en:
...
## Ajuste visual final de grupos y MVP_PLAN

Estado: Aprobado e integrado  
Cambio relacionado: CAMBIO #020  
Fase: Fase 10 — MVP técnico básico en preparación

### Criterio visual actual en Obsidian
...
ROBERT_MVP_PLAN queda integrado visualmente dentro de:
...
## INTERACTION_FLOW_SPEC v0.2 aprobado

Estado: Aprobado e integrado  
Decisión relacionada: DECISIÓN #014  
Cambio relacionado: CAMBIO #023  
Fase: Fase 10 — MVP técnico básico en preparación

### Estado actualizado

ROBERT_TECHNICAL_INTERACTION_FLOW_SPEC v0.2 queda aprobado e integrado como documento técnico documental del MVP técnico básico de Robert.

### Qué define

Este documento define cómo interactúan conceptualmente los componentes principales del MVP técnico básico:
...
## ROBERT_COMMANDS v0.4 aprobado

Estado: Aprobado e integrado  
Decisión relacionada: DECISIÓN #016  
Cambio relacionado: CAMBIO #027  
Versión anterior aprobada: ROBERT_COMMANDS v0.3  
Fase: Fase 10 — MVP técnico básico en preparación
...
## USER_ACTIONS_SPEC v0.2 aprobado
...
ROBERT_TECHNICAL_USER_ACTIONS_SPEC v0.2 queda aprobado e integrado como documento técnico documental del MVP técnico básico de Robert.

### Qué define

Este documento define las acciones conceptuales que el usuario puede intentar desde cada pantalla o panel del MVP técnico básico:
...
## ERROR_AND_BLOCKING_SPEC v0.2 aprobado

Estado: Aprobado e integrado  
Decisión relacionada: DECISIÓN #018  
Cambio relacionado: CAMBIO #030  
Fase: Fase 10 — MVP técnico básico en preparación  
Documento base principal: ROBERT_TECHNICAL_USER_ACTIONS_SPEC v0.2  
Documento maestro relacionado: ROBERT_COMMANDS v0.4
...
ROBERT_TECHNICAL_ERROR_AND_BLOCKING_SPEC v0.2 queda aprobado e integrado como documento técnico documental del MVP técnico básico de Robert.
...
## PERMISSIONS_AND_SCOPES_SPEC v0.2 corregido
...
ROBERT_TECHNICAL_PERMISSIONS_AND_SCOPES_SPEC fue actualizado de v0.1 a:
...
## PERMISSIONS_AND_SCOPES_SPEC v0.2 aprobado

Estado: Aprobado e integrado  
Decisión relacionada: DECISIÓN #019  
Cambio relacionado: CAMBIO #032  
Fase: Fase 10 — MVP técnico básico en preparación  
Documento base principal: ROBERT_TECHNICAL_ERROR_AND_BLOCKING_SPEC v0.2  
Documentos relacionados: ROBERT_COMMANDS v0.4, ROBERT_TECHNICAL_USER_ACTIONS_SPEC v0.2, ROBERT_TECHNICAL_DATA_MODEL_SPEC v0.1, ROBERT_TECHNICAL_COMPONENTS_SPEC v0.2, ROBERT_TECHNICAL_SCREEN_STATE_SPEC v0.2, ROBERT_TECHNICAL_INTERACTION_FLOW_SPEC v0.2
...
ROBERT_TECHNICAL_PERMISSIONS_AND_SCOPES_SPEC v0.2 queda aprobado e integrado como documento técnico documental del MVP técnico básico de Robert.
...
## NOTIFICATION_AND_ALERTS_SPEC v0.2 aprobado

Estado: Aprobado e integrado  
Decisión relacionada: DECISIÓN #021  
Cambio relacionado: CAMBIO #036  
Fase: Fase 10 — MVP técnico básico en preparación  
Documento base principal: ROBERT_TECHNICAL_AUDIT_TRAIL_SPEC v0.2  
Documentos relacionados: ROBERT_COMMANDS v0.4, ROBERT_TECHNICAL_PERMISSIONS_AND_SCOPES_SPEC v0.2, ROBERT_TECHNICAL_ERROR_AND_BLOCKING_SPEC v0.2, ROBERT_TECHNICAL_USER_ACTIONS_SPEC v0.2, ROBERT_TECHNICAL_DATA_MODEL_SPEC v0.1, ROBERT_TECHNICAL_COMPONENTS_SPEC v0.2, ROBERT_TECHNICAL_SCREEN_STATE_SPEC v0.2, ROBERT_TECHNICAL_INTERACTION_FLOW_SPEC v0.2
...
ROBERT_TECHNICAL_NOTIFICATION_AND_ALERTS_SPEC v0.2 queda aprobado e integrado como documento técnico documental del MVP técnico básico de Robert.
...
Estado: Aprobado e integrado  
Decisión relacionada: DECISIÓN #022  
Cambio relacionado: CAMBIO #038  
Fase: Fase 10 — MVP técnico básico en preparación  
Documento base principal: ROBERT_TECHNICAL_NOTIFICATION_AND_ALERTS_SPEC v0.2  
Documentos relacionados: ROBERT_COMMANDS v0.4, ROBERT_TECHNICAL_AUDIT_TRAIL_SPEC v0.2, ROBERT_TECHNICAL_PERMISSIONS_AND_SCOPES_SPEC v0.2, ROBERT_TECHNICAL_ERROR_AND_BLOCKING_SPEC v0.2, ROBERT_TECHNICAL_USER_ACTIONS_SPEC v0.2, ROBERT_TECHNICAL_DATA_MODEL_SPEC v0.1, ROBERT_TECHNICAL_COMPONENTS_SPEC v0.2, ROBERT_TECHNICAL_SCREEN_STATE_SPEC v0.2, ROBERT_TECHNICAL_INTERACTION_FLOW_SPEC v0.2
...
ROBERT_TECHNICAL_SESSION_AND_CONTEXT_SPEC v0.2 queda aprobado e integrado como documento técnico documental del MVP técnico básico de Robert.
...
## DOCUMENT_LIFECYCLE_SPEC v0.2 corregido

Estado: Propuesta corregida — pendiente de revisión  
Cambio relacionado: CAMBIO #039  
Fase: Fase 10 — MVP técnico básico en preparación  
...
ROBERT_TECHNICAL_DOCUMENT_LIFECYCLE_SPEC fue actualizado de v0.1 a:
...
Estado: Aprobado e integrado  
Decisión relacionada: DECISIÓN #023  
Cambio relacionado: CAMBIO #040  
Fase: Fase 10 — MVP técnico básico en preparación  
Documento base principal: ROBERT_TECHNICAL_SESSION_AND_CONTEXT_SPEC v0.2  
Documentos relacionados: ROBERT_COMMANDS v0.4, ROBERT_TECHNICAL_NOTIFICATION_AND_ALERTS_SPEC v0.2, ROBERT_TECHNICAL_AUDIT_TRAIL_SPEC v0.2, ROBERT_TECHNICAL_PERMISSIONS_AND_SCOPES_SPEC v0.2, ROBERT_TECHNICAL_ERROR_AND_BLOCKING_SPEC v0.2, ROBERT_TECHNICAL_USER_ACTIONS_SPEC v0.2, ROBERT_TECHNICAL_DATA_MODEL_SPEC v0.1, ROBERT_TECHNICAL_COMPONENTS_SPEC v0.2, ROBERT_TECHNICAL_SCREEN_STATE_SPEC v0.2, ROBERT_TECHNICAL_INTERACTION_FLOW_SPEC v0.2
...
ROBERT_TECHNICAL_DOCUMENT_LIFECYCLE_SPEC v0.2 queda aprobado e integrado como documento técnico documental del MVP técnico básico de Robert.
...
## DATA_CONSISTENCY_AND_CONFLICT_RESOLUTION_SPEC v0.3 corregido

Estado: Propuesta corregida — pendiente de revisión  
Cambio relacionado: CAMBIO #043  
Fase: Fase 10 — MVP técnico básico en preparación  
...
ROBERT_TECHNICAL_DATA_CONSISTENCY_AND_CONFLICT_RESOLUTION_SPEC fue actualizado de v0.2 a:
