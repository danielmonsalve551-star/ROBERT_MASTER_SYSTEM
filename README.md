...
6. EXPLICIT HUMAN DECISION ON PHASE 10 CLOSURE — CURRENT
```
...
La siguiente transición solo podrá ocurrir mediante una decisión humana explícita posterior al resultado:
